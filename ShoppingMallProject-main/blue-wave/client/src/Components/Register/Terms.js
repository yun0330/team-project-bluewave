...
const Terms = ({setAllChecked}) => {
  const [checkbox1, setCheckbox1] = useState(false);
  const [checkbox2, setCheckbox2] = useState(false);

  useEffect(()=>{
    setAllChecked(checkbox1 && checkbox2);
  },[checkbox1,checkbox2]);
            ...
            <div className="terms_box">
              <div className="check_terms">
                  <div className="form-check">
                      <input className="form-check-input" type="checkbox" id="group_check1" onChange={handleCheckbox1Change}/>
                      <label className="form-check-label" htmlFor="group_check1">
                          <p className="check_txt"><span className="must_txt">[필수]</span> 이용약관 동의</p>
                      </label>
                      <div className="agree">
                        <dl>
                          <dt>
                          ...
                          <dd>
                            이 약관은 이젠아카데미3조 회사(전자상거래 사업자)가 운영하는 블루웨이브 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br/>
                          ...
                          <dd>
                            ① “몰”이란 이젠아카데미3조 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br/>
              ...
              <div className="check_terms">
                  <div className="form-check">
                      <input className="form-check-input" type="checkbox" id="group_check2" onChange={handleCheckbox2Change}/>
                      <label className="form-check-label" htmlFor="group_check2">
                          <p className="check_txt"><span className="must_txt">[필수]</span> 개인정보 수집 및 이용 동의</p>
                      </label>
                      <div className="agree">
                          <dl>
                              <dt>
